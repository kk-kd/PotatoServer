...
export const EditUser = () => {
  ...
  const [passwordCandidateValidation, setPasswordCandidateValidation] =
    useState("");
  ...
  const ModifyUserCall = async (form_results) => {
    try {
      let update_user_response = await updateUser(
        id,
        form_results,
        changePassword
      );
  ...
  const handleModifyUser = (e) => {
    ...
    let form_results = {
      ...
      isAdmin: isAdmin,
      password:
        !changePassword || !passwordCandidate ? oldPassword : passwordCandidate,
      longitude: lng,
      latitude: lat,
    };
  ...
  return (
    <div>
      <h1> Edit User </h1>
      <div>
        <form newUserClicked={false} id="edit-user-form">
          <div>
            <label className="edit-user-input">
              <p>First Name:</p>
              <input
                type="text"
                maxLength="100"
            ...
            <label className="edit-user-input">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setPasswordCandidateValidation("");
                }}
              />
            </label>
              ...
              <div>
                <label className="edit-user-input">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPasswordCandidateValidation(e.target.value)
                    }
                  />
                </label>
              </div>

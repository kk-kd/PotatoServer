...
export const ExistErrorPage = ({activeError, setActiveErrror, existErrors, setExistErrors,processingComplete, setProcessingComplete, fileData, setFileData}) => {
 
    return (
        <div> Exist Error Page
